		...
		<tbody>
			...
			<tr id="general-settings">
				<td colspan="2" style="padding:0;">
					...
					<p class="description"><?php _e( 'Manage export options across Doo Product Exporter from this screen. Options are broken into sections for different export formats and methods. Click Save Changes to apply changes.', 'woo_ce' ); ?></p>
				</td>
			</tr>
